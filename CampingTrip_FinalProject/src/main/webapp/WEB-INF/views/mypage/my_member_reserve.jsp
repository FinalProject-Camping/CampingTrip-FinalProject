				...
				<nav class="navbar navbar-light" id="navbar">
					<ul class="navbar-nav">
						...
						<li class="nav-item active">
							<a class="nav-link font-weight-bold" id="active" href="member_reservlist.do">예약 리스트</a>
							<ul class="submenu">
			...
			<div class="col-md-10" id="contentDiv">
				<div class="row justify-content-center">
					<div class="col-md-12 order-md-1">
						<br>
						<h3 class="mb-3" style="font-weight: bold; margin:auto; width:20%;">${loginId }님 캠핑지 예약내역</h3>
						<br>
						<c:choose>
