...
<script type="text/javascript">
	...
	function window() {
		var url = "mypage/my_admin_reportlist.jsp";
		window.open(url, "window", "width=500px, height=400px");
	}
</script>
									...
									<c:otherwise>
										<c:forEach items="${list }" var="dto">
											<tr>
												...
												<td>${dto.myid }</td>
												<td>${dto.myrole }</td>
												<td><a href='admin_reportlist.do?myid=${dto.report.writer }' onclick="window.open('admin_reportlist.do','window','location=no, directories=no,resizable=no,status=no,toolbar=no,menubar=no, width=900,height=500,left=350, top=200, scrollbars=yes');return false">접수내역보기</a></td>
												<td>${dto.mypenalty }</td>
												<td>
													<div class="buttonDiv">
