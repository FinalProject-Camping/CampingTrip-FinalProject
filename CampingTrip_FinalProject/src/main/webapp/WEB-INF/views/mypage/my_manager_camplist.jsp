									...
									<c:otherwise>
										<c:forEach items="${list }" var="dto">
											<tr>
												...
												<td><a href="manager_roomdetail.do?roomno=${dto.roomno }">
												camp.campno = ${dto.myCampDto.campno}<br>
												room.campno = ${dto.campno}<br>
												room.roomno = ${dto.roomno}<br>
												room_name = ${dto.room_name }</a></td>
											</tr>
										</c:forEach>
									</c:otherwise>
								</c:choose>
