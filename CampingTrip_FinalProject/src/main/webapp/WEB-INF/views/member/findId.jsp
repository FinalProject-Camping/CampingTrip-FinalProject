...
<script type="text/javascript">
	function ajaxFindId(){
		...
		if(myname == null || myname == "" || mybirth == null || mybirth == "" || myphone == null || myphone == ""){
			...
			$.ajax({
				...
				success:function(msg){
					...
					if(msg.rtnId!="" && msg.rtnId != null){
						alert('회원님의 ID는 '+msg.rtnId+' 입니다.');
						//id찾으면 로그인화면으로 이동
						location.href="loginform.do";
					}else{
						alert("입력하신 정보에 해당하는 회원 ID가 없습니다. 다시 확인해주세요.");
					}
				},
				error:function(){
					alert("통신 실패");
...
<body>
	<div class="center" style="width:300px;">
		<h3 style="text-align:left;  font-family: EliceDigitalBaeum_Bold;">ID찾기</h3>
		<br>
			<p>
